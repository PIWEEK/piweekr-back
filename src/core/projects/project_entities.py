...
#
#class ProjectIsFromIdea(Relationship11):
#    role_from = RoleSingle(role_class=idea_entities.Idea, role_name="idea_from")
#    role_to = RoleDingle(role_class=Project, role_name="project", role_fk="idea_from_id", required=False)
#
#
