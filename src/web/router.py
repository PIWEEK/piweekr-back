...
urls = [
    ...
    url(PREFIX + "/users/me", user_handlers.UsersMe(), methods=["get", "post"]),
    # Ideas
    ...
    url(PREFIX + "/ideas/<string:idea_uuid>/comments", idea_handlers.IdeaComentsList(), methods=["get", "post", "delete"]),
    # Projects
